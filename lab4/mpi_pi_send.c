...
int score, score_1, score_2, score_3, score_4, n;
...
/* calculate pi */
printf("Au cazut %d sageti in cadranul 1\n", score_1);
printf("Au cazut %d sageti in cadranul 2\n", score_2);
printf("Au cazut %d sageti in cadranul 3\n", score_3);
printf("Au cazut %d sageti in cadranul 4\n", score_4);
